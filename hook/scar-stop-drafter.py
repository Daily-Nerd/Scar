...
def main():
    ...
    reason = (
        ...
        f"any evidence) to {candidates}/<slug>.md — COPY the format from "
        f"{scars_dir}/template.md (YAML frontmatter mandatory, status: "
        f"candidate); it stays a candidate until a human reviews it. "
