...
- Enforcement happens **at the moment of action**:
  ...
  - MCP server — any agent can query the scar graph
...
Concept stage. This repository is the idea, stress-tested, before a line of product code is written — exactly the discipline SCAR itself exists to encourage.
